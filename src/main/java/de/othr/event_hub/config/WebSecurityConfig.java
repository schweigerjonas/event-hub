    ...
    SecurityFilterChain apiFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/friendships").hasAuthority("ADMIN")
                        .requestMatchers(HttpMethod.DELETE,"/api/friendships").hasAuthority("ADMIN")
                        .requestMatchers("/api/friendships/active", "/api/friendships/pending").hasAuthority("ADMIN")
