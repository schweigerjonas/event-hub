...
import de.othr.event_hub.config.CustomWebAuthenticationDetailsSource;
...
public class AuthenticationController {
    ...
    public ResponseEntity<AuthenticationResponse> register(@RequestBody RegisterRequest registerRequest) {
        ...
        for (int i = 0; i < registerRequest.getAuthorities().size(); i++) {
            Optional<Authority> authorityOp = authorityRepository
                    .findById(registerRequest.getAuthorities().get(i).getId());
